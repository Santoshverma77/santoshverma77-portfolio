...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "Instagram",
      url: "https://instagram.com/santoshverma_77",
      icon: (
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/santoshverma_77",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Snapchat",
      url: "https://snapchat.com/add/santoshverma_77",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/santoshverma",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "GitHub",
      url: "https://github.com/santoshverma",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
